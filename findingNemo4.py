...
def welcomeScreen():
    ...
    #Aim
    text=myFont.render("   Help Marlin find Nemo    ",True,RED)         
    screen.blit(text,(50,150))
    #rules
    text=smallFont.render("   Press space to start.    ",True,BLACK)         
    screen.blit(text,(20,300))
    text=smallFont.render("   Use arrow keys to navigate.    ",True,WHITE)         
    screen.blit(text,(20,325))
    text=smallFont.render("   Touching enemies will reduce your life.    ",True,BLACK)         
    ...
    while True:
        ...
        if pygame.sprite.spritecollideany(player, enemy_group):
            ...
            if life==0:
                ...
                sound="losesound.mp3" 
                #image
                image="losescreen.jpg"
                #text
                text=myFont.render("   Come... get me fast!!    ",True,RED)
                #call endscreen
        ...
        if pygame.sprite.collide_rect(player, target):
            ...
            image="winscreen.jpg"
            #text
            text=myFont.render("Thanks for uniting us..",True,WHITE)
            #call end screen
            endScreen(sound,image,text)
            return
